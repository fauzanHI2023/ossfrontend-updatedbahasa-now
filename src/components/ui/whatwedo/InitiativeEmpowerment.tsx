...
import {initiativeEmpowerment} from '@/data/data';
import Image from 'next/image';

interface InitiativeEmpowermentProps {
  tab: string; // props untuk filter tab
}

const InitiativeEmpowerment: React.FC<InitiativeEmpowermentProps> = ({tab}) => {
  const filteredItems = initiativeEmpowerment.filter(
    (item) => item.tab === tab
  );
...
export default InitiativeEmpowerment;
